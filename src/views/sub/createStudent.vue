<template>
    <div>
        <el-row>
            <el-col :span="4"><h2>添加学生</h2></el-col>
        </el-row>
        <el-row class="mainStudentCard">
            <el-col :span="12">
                ...
                <el-row>
                    ...
                    <el-col :span="20">
                        <el-input v-model="info.sid" placeholder="" class="info_input"></el-input>
                    </el-col>
                </el-row>
                <spaceRow></spaceRow>
                <el-row>
        ...
        <el-row justify="center">
            <el-col :span="4">
                <el-button type="success" @click="prepareUpload" class="info_input">添加</el-button>
            </el-col>
        </el-row>       
    </div>
</template>
